...
public class Ejercicio4Controller implements Initializable {
    ...
    private void comprobarRespuestas(ActionEvent event){
        ...
        if(text2.getText().equals("C1+C2+C3+C4+C5")){
            resultado++;
        }
        if(text3.getText().equals("5")){
            resultado++;
        }
        if(text4.getText().equals("PROM>=6")){
            resultado++;
        }
        if(text5.getText().equals("APROBADO")){
            resultado++;
        }
        if(text6.getText().equals("NO APROBADO")){
            resultado++;
        }
        if(text7.getText().equals("DEL CONDICIONAL")){
            resultado++;
        }
